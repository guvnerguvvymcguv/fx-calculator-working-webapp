              ...
              <>
                <div>
                  ...
                  <Input
                    ...
                    className="mt-2 bg-gray-950/50 border border-white/0 hover:border-white/20 focus:border-white/40 text-white shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)] transition-all duration-200 focus:outline-none focus:ring-0"
                  />
                </div>
