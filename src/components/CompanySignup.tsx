              ...
              <>
                <div>
                  ...
                  <Input
                    ...
                    className="mt-2 bg-gray-950/50 border border-white/0 hover:border-white/20 focus:border-white/40 text-white shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)] transition-colors duration-200 outline-none focus-visible:outline-none focus:ring-0 focus-visible:ring-0 focus:ring-offset-0"
                  />
                </div>
            ...
            <div className="flex justify-between">
              {step > 1 && (
                <Button
                  ...
                  className="bg-transparent hover:bg-white/10 border border-transparent hover:border-white/20 text-gray-300 hover:text-white transition-all duration-200 px-4 py-2 rounded-md"
                >
                  Back
                </Button>
              )}
