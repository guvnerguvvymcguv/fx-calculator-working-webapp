              ...
              <>
                <div>
                  ...
                  <Input
                    ...
                    className="mt-2 bg-gray-950/50 hover:bg-gray-900/60 focus:bg-gray-900/70 border border-transparent text-white shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)] transition-all duration-200 focus:outline-none focus:ring-0"
                  />
                </div>
