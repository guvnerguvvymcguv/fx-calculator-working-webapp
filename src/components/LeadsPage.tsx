              ...
              <CardContent className="pt-6">
                ...
                {(companySearchTerm || hasSearched) && (
                  <button
                    ...
                    className="w-full mt-4 px-6 py-3 bg-transparent hover:bg-white/10 active:bg-white/15 border border-transparent hover:border-white/20 text-purple-200 hover:text-white rounded-lg transition-all duration-200 font-medium"
                  >
                    Reset
                  </button>
                )}
