...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "You can add unlimited team members based on your subscription. Our pricing scales with your team size: £30/seat/month for 1-5 seats, £27/seat/month for 6-12 seats (10% discount), and £24/seat/month for 13+ seats (20% discount). Annual plans receive an additional 20% discount."
  }
];
